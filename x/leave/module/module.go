...
import (
	...
	"leave-cosmos/x/leave/client/cli"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	types.RegisterTxMsgServer(cfg.MsgServer(), am.studentkeeper)
	types.RegisterQueryMsgServer(cfg.QueryServer(), am.studentkeeper)
}
...
func (a AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx sdkclient.Context, mux *runtime.ServeMux) {
	if err := types.RegisterQueryMsgHandlerClient(context.Background(), mux, types.NewQueryMsgClient(clientCtx)); err != nil {
		panic(err)
	}
}
